...
<div class="container">
    ...
    <p class="note">If you see the time updating, SvelteKit is successfully running on the client after PHP served the initial HTML.</p>
...
<style>
    ...
    .box { padding: 1rem; border-radius: 4px; margin: 1rem 0; }
