...
export async function verifyBuildStamp(buildDir, expectedMode, expectedBasePath) {
    ...
    try {
        ...
        if (normalizedActualMode !== normalizedExpectedMode) {
            return { ok: false, error: `Mode mismatch: expected '${normalizedExpectedMode}', got '${stamp.mode}'` };
        }
        ...
        if (normActual !== normExpected) {
             return { ok: false, error: `BasePath mismatch: expected '${normExpected}', got '${normActual}'` };
        }
